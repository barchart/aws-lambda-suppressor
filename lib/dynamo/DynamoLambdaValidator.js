...
module.exports = (() => {
	...
	// 2020/11/29, BRU. This class will be removed in the next major release.
	// See the @barachart/common-node-js package for more details. Going forward,
	...
	class DynamoLambdaValidator extends LambdaValidator {
		...
		_validate(name, trigger, messageId) {
			return this._messageValidator.validate(name, null, null, messageId, trigger);
		}
