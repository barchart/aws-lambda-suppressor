...
const DynamoProvider = require('@barchart/common-node-js/aws/DynamoProvider'),
	LambdaEventValidator = require('@barchart/common-node-js/aws/lambda/LambdaEventValidator'),
...
module.exports = (() => {
	 ...
	 * @param {String} prefix
	 */
	class DynamoValidator extends LambdaEventValidator {
